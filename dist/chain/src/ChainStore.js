            ...
            _bitsharesjsWs.Apis.instance()
                ...
                .then(function(optional_witness_object) {
                    if (optional_witness_object) {
                        ...
                        _this8.witness_by_account_id = _this8.witness_by_account_id.set(
                            optional_witness_object.witness_account,
                            optional_witness_object.id
                        );
                        var witness_object = _this8._updateObject(
            ...
            _bitsharesjsWs.Apis.instance()
                ...
                .then(function(optional_committee_object) {
                    if (optional_committee_object) {
                        ...
                        _this9.committee_by_account_id = _this9.committee_by_account_id.set(
                            optional_committee_object.committee_member_account,
                            optional_committee_object.id
                        );
                        var committee_object = _this9._updateObject(
            ...
            _bitsharesjsWs.Apis.instance()
                ...
                .then(
                    function(results) {
                        if (results.length === 0) {
                            if (
                                _ChainValidation2.default.is_object_id(
                                    name_or_id
                                )
                            ) {
                        ...
                        _this10.get_full_accounts_subscriptions.set(
                        ...
                        account.assets = new _immutable2.default.List(
                            assets || []
                        );
                    ...
                    function(error) {
                        console.log("Error: ", error);
                        if (_ChainValidation2.default.is_object_id(name_or_id))
                            _this10.objects_by_id.delete(name_or_id);
                        else _this10.accounts_by_name.delete(name_or_id);
                    }
                );
        }
        return undefined;
        ...
        pending_request.promise = new Promise(function(resolve, reject) {
            _bitsharesjsWs.Apis.instance()
                ...
                .then(function(operations) {
                    ...
                    var pending_request = _this11.account_history_requests.get(
                        account_id
                    );
